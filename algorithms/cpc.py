...
class CPCBuilder(AlgorithmBuilderBase):
    ...
    def apply_prediction_model_to_encoder(self, encoder_model):
        ...
        x_encoded = TimeDistributed(model_with_embed_dim, name='td')(x_input)
    ...
    def get_encoder_from_model(self, model):
        return model.get_layer('td').layer.layers[0]

    def set_encoder(self, model, encoder):
        self.enc_model = model.get_layer('td').layer.layers[0] = encoder
        return model
